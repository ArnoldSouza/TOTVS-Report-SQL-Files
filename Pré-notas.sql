SELECT
	...
	CASE
		WHEN (SC7010.C7_USER IN ('000048','000044','000053','001193','001372','000238'))
			THEN 'COMPRAS'
		WHEN (SC7010.C7_USER IN ('001586','000821','000069','001417','000148','000852','000896','000655','000224','000190','001036','000444','001481','000797'))
			THEN 'ADM'
		WHEN (SC7010.C7_USER IN ('000216','001353','001362','000892','000815','001212','000554','000485','000663','001136','001042','000262','000937','000364','000567','001281','001391','001337','000246','001433','000894','001540','001328','000316','000993','000370','000376','000807','000306','000301','001506','000208','000571','000917','001562','000720','001329','001468','000435','001368','000283','000401','000070','000628','000670','000856','001067','001447','001519','001536','001570','001588','001609','001613','001678','001683','001699'))
			THEN 'LOCAL'
		WHEN (SC7010.C7_USER IN ('000646','001494','001039','000226','001520','001165','001480','001211','000932','000050','000215','001145','000902','001280','000593','001161','000045','000509','000767','001062','001073','001485','001721'))
			THEN 'MATRIZ - OUTROS'
		ELSE 'ERRO: CLASSIFICAR'
	END AS 'DPTO COMPRA'
...
FROM PROTHEUS.dbo.SD1010 SD1010 WITH (NOLOCK)
	...
	LEFT MERGE JOIN PROTHEUS.dbo.SX5010 SX5010 WITH (NOLOCK) ON SX5010.X5_TABELA='13' AND SX5010.X5_CHAVE=SF4010.F4_CF AND SX5010.D_E_L_E_T_<>'*'
	--CONEXÃO SC E PC
...
WHERE
	...
	(
		...
		(SF1010.F1_ESPECIE NOT LIKE 'NFE') -- retira importaçãxo 3
	) AND
