/* -- ENTRADA POR PRÉ-NOTA */
	...
	WHERE 
		...
		(((SF1010.F1_DTDIGIT>='20150101' AND SF1010.F1_DTDIGIT<='20171231') AND ((SF4010.F4_ESTOQUE='S') OR (SF4010.F4_CODIGO='103' OR SF4010.F4_CODIGO='140'))) OR 
		((SF1010.F1_DTDIGIT>='20150101' AND SF1010.F1_DTDIGIT<='20171231') AND (SD1010.D1_CC='          ' AND SD1010.D1_TES='   '))) AND
		SD1010.D1_FILIAL = '02' AND 
		SD1010.D1_LOCAL = '25' 
		-- AND 
		-- (
			-- SD1010.D1_COD='02500847' OR
			-- SD1010.D1_COD='02500843'
		-- )
	GROUP BY 
		SD1010.D1_FILIAL, 
		SD1010.D1_LOCAL, 
...
Union ALL
	...
	WHERE
		...
		((SD3010.D3_EMISSAO>='20150101') AND (SD3010.D3_EMISSAO<='20171231')) AND
		SD3010.D3_FILIAL = '02' AND
		SD3010.D3_LOCAL = '25'
		-- AND 
		-- (
			-- SD3010.D3_COD='02500847' OR
			-- SD3010.D3_COD='02500843'
		-- )
	GROUP BY 
		SD3010.D3_FILIAL,
		SD3010.D3_LOCAL,
...
Union ALL
	...
	/* -- MOVIMENTOS POR TRANSFERÊNCIA EXTERNA */
	SELECT
		...
		'PV-TRANSF. EXT.' AS 'TIPO DOCUMENTO',
	...
	WHERE
		...
		((SD2010.D2_EMISSAO>='20150101') AND (SD2010.D2_EMISSAO<='20171231')) AND
		SF4010.F4_ESTOQUE='S' AND
		SD2010.D2_FILIAL = '02' AND
		SD2010.D2_LOCAL = '25'
		-- AND 
		-- (
			-- SD2010.D2_COD='02500847' OR
			-- SD2010.D2_COD='02500843'
		-- )
	GROUP BY 
		SD2010.D2_FILIAL,
		SD2010.D2_LOCAL,
