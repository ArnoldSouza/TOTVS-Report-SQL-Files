...
WHERE
	(SC1010.D_E_L_E_T_<>'*')
	AND (SC1010.C1_EMISSAO>='20200201' AND SC1010.C1_EMISSAO<=GETDATE())
	--AND (SC1010.C1_FILIAL = '09')
	AND (SC1010.C1_CC = '         ') --PARA ESTOQUE
	AND (SC1010.C1_QUJE<SC1010.C1_QUANT)
    --AND RTRIM(SC1010.C1_CLVL) <> '001'
    --AND SC1010.C1_NUM IN ('320489', '315885', '320484')
ORDER BY
