SELECT
	...
	CASE
		WHEN (SY1010.Y1_USER IN ('000044','000053','001193','001372','000238'))
			THEN 'COMPRAS'
		WHEN (SY1010.Y1_USER IN ('000069','001417','000148','000852','000896','000655','000224','000190','001036','000444','001481','000797','001067','000048'))
			THEN 'ADM'
		WHEN (SY1010.Y1_USER IN ('001519','000216','001353','001362','000892','000815','001212','000554','000485','000663','001136','001042','000262','000937','000364','000567','001281','001391','001337','000246','001433','000894','001540','001328','000316','000993','000370','000376','000807','000306','000301','001506','000208','000571','000917','001562','000720','001329','001468','000435','001368','000283','000401'))
			THEN 'LOCAL'
		WHEN (SY1010.Y1_USER IN ('000646','001494','001039','000226','001520','001165','001480','001211','000932','000050','000215','001145','000902','001280','000593','001161','001073','000578'))
			THEN 'MATRIZ - OUTROS'
...
FROM PROTHEUS.dbo.SC1010 SC1010
	...
	LEFT JOIN PROTHEUS.dbo.CTH010 CTH010 ON SC1010.C1_CLVL=CTH010.CTH_CLVL AND CTH010.D_E_L_E_T_<>'*'
	LEFT JOIN PROTHEUS.dbo.CTD010 CTD010 ON SC1010.C1_ITEMCTA=CTD010.CTD_ITEM AND CTD010.D_E_L_E_T_<>'*'
	...
	LEFT JOIN PROTHEUS.dbo.SA2010 SA2010 ON SA2010.A2_COD=SC1010.C1_FORNECE AND SA2010.A2_LOJA=SC1010.C1_LOJA AND SA2010.D_E_L_E_T_<>'*'
	--LEFT JOIN PROTHEUS.dbo.SC7010 SC7010 ON (SC1010.C1_PEDIDO=SC7010.C7_NUM AND SC1010.C1_ITEMPED=SC7010.C7_ITEM) AND SC7010.D_E_L_E_T_<>'*'
	
WHERE
	(SC1010.D_E_L_E_T_<>'*') 
	AND (SC1010.C1_EMISSAO>='20180101' AND SC1010.C1_EMISSAO<=GETDATE())
