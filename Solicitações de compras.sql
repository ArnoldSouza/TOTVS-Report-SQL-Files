SELECT 
	...
	CASE WHEN SC7010.C7_USER='000044' THEN 'SILAS' WHEN SC7010.C7_USER='000053' THEN 'NILO' ELSE 'ERRO' END AS 'COMPRADOR DO PC'
...
WHERE
	...
	AND (SC1010.C1_RESIDUO = ' ')
 	AND SC1010.C1_QUJE>0 --SC1010.C1_QUANT
	...
	AND (SC1010.C1_CC = '         ')
	AND (SC7010.C7_USER='000044' OR SC7010.C7_USER='000053')
