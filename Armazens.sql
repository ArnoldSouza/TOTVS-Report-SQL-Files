SELECT 
	...
	(
		...
		WHERE
			...
			(
				SD3010.D3_EMISSAO>=DATEADD(DAY,-365,GETDATE()) AND
				SD3010.D3_EMISSAO<=GETDATE()
			) AND
			(SD3010.D3_CLVL<>'001') AND
	...
	(
		...
		WHERE
			...
			(SD3010.D3_TM<>'999') AND
			(
				SD3010.D3_EMISSAO>=DATEADD(DAY,-90,GETDATE()) AND
				SD3010.D3_EMISSAO<=GETDATE()
			) AND
			(SD3010.D3_CLVL<>'001') AND
			(SD3010.D3_FILIAL=Z01010.Z01_FILIAL AND SD3010.D3_LOCAL=Z01010.Z01_COD)
